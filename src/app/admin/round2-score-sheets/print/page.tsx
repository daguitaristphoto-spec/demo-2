...
function getGroupMax(group: CriteriaGroup) {
      ...
      <main style={{ maxWidth: 1000, margin: "0 auto", padding: 24 }}>
        ...
        <p style={{ color: "red" }}>
          {scoreItemsError instanceof Error
            ...
            : "Không tải được điểm chi tiết vòng 2"}
        </p>
        <Link href="/admin" className="btn btn-secondary">
          Quay lại admin
        </Link>
    ...
    <main className="print-root">
      ...
      {sheetRows.length === 0 ? (
        <section className="empty-state">
          ...
          <h1>Chưa có phiếu chấm vòng 2</h1>
          <p>
            Hiện chưa có phiếu chấm vòng 2 nào được nộp chính thức. Sau khi giám khảo
            nộp điểm cho các cặp thí sinh, hệ thống sẽ tự hiển thị danh sách phiếu
            để in hoặc lưu PDF.
          </p>
