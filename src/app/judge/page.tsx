...
export default function JudgeRound3Page() {
  ...
  async function loadRound3State() {
    ...
    try {
      ...
      const nextContestants = nextStageStates[nextActiveStageId];
      const firstPending =
        nextContestants.contestants.find((contestant) => !isSubmitted(contestant)) ||
        nextContestants.contestants[0];
